    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 p-4">
        ...
        <div>
          ...
          <span className="mt-1 inline-block rounded-full bg-indigo-50 dark:bg-indigo-900/30 px-2 py-0.5 text-xs font-medium text-indigo-700 dark:text-indigo-300">
            Tutor
          </span>
          {structure && (
            <p className="mt-1 text-xs text-gray-400 dark:text-gray-500">📍 {structure.name}</p>
          )}
        </div>
      </div>
