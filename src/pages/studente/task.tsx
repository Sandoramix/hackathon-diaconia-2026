        ...
        return (
          <button
            ...
            className={cn(
              ...
              isSelected ? "bg-blue-600 text-white" : isToday ? "bg-blue-50 text-blue-700 border border-blue-200" : "bg-white border border-gray-200 text-gray-700 hover:bg-gray-50",
            )}
          >
    ...
    <div className="space-y-4">
      ...
      {completableTasks.length > 0 && (
        <div className="space-y-2">
          <p className="text-xs font-semibold uppercase tracking-wide text-gray-400">Da completare</p>
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className={cn("font-semibold text-sm", isDone && "line-through text-gray-400")}>{task.title}</p>
                  {task.description && (
      ...
      {slotTasks.length > 0 && (
        <>
          {completableTasks.length > 0 && (
            <p className="text-xs font-semibold uppercase tracking-wide text-gray-400 pt-2">Con slot</p>
          )}
          <DateStrip
