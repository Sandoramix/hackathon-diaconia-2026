...
async function main() {
  ...
  const RULES = [
    ...
    { icon: "composite:Home,Clock:orange",         text: "Devi essere nella struttura entro le *immettere ora" },
    { icon: "lucide:Utensils:green",               text: "Sei con altre persone: prendi la giusta quantità di cibo e mangia in cucina" },
